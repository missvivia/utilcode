...
import com.xyl.mmall.security.filter.MmallMobileAuthenticatingTestFilter;
...
@Configuration
@Profile("dev")
@PropertySource(value = "classpath:/config/dev/mobileSecurity.properties")
...
//		filter.setMobileTokenService(context.getBean(BEAN_NAME_MOBILE_TOKEN_SERVICE, MobileTokenService.class));
		MmallMobileAuthenticatingTestFilter filter = new MmallMobileAuthenticatingTestFilter();
