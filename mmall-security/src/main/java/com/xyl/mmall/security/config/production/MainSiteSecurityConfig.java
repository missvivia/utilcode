 ...
 * 
 */
package com.xyl.mmall.security.config.production;
...
import com.xyl.mmall.security.filter.MmallMainSiteAuthenticatingTestFilter;
...
@Configuration
@Profile("production")
@PropertySource(value = "classpath:/config/production/mainSiteSecurity.properties")
...
public class MainSiteSecurityConfig extends BaseSecurityConfig
{
     ...
     * {@link Bean} annotation to avoid auto-load as {@link Filter} by spring boot.
     * 
     * @return
     */
    Filter authWebFilter()
    {
        ...
        MmallMainSiteAuthenticatingTestFilter filter = new MmallMainSiteAuthenticatingTestFilter();
        // filter.setAccountValidator(context.getBean(BEAN_NAME_ACCOUNT_VALIDATOR_OAUTH,
    ...
    MainSiteAuthcService mainSiteAuthcService()
    {
        ...
        mainSiteAuthcService
                .setRetrieveOauthAccessTokenUrl(env.getProperty(OAUTH_ACCESS_TOKEN_URL));
