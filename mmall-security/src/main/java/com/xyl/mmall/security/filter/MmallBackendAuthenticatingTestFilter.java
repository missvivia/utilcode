 ...
 * @author yydx811
 */
public class MmallBackendAuthenticatingTestFilter extends AccessControlFilter
{
    ...
    protected String getTokenValue(ServletRequest request)
    {
        ...
        String value = httpServletRequest.getParameter(MmallConstant.XYL_BACKEND_SESS);
    ...
    protected boolean isLogined(ServletRequest request, ServletResponse response)
    {
        ...
        if (currentUser != null && currentUser.isAuthenticated())
        {
            ...
            Cookie [] credentials = CookieUtils.getBackendCredentials(httpServletRequest);
    ...
    public MmallAuthenticationToken createToken(ServletRequest request, ServletResponse response)
    {
        ...
        Cookie exp = CookieUtils.getCookieByName(httpRequest, MmallConstant.XYL_BACKEND_EXPIRES);
        String expires = "";
        ...
        Cookie [] credentials = CookieUtils.getBackendCredentials(httpRequest);
        if (credentials == null)
        {
            return null;
        }
        String username = CookieUtils.getCookieByName(httpRequest, MmallConstant.XYL_BACKEND_USERNAME).getValue();
