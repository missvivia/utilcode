 ...
 * 
 * 系统将退货请求中的优惠券+红包退还给用户
 * 
 */
@JobPath("/returnCouponHbRecycle")
@Service
public class ReturnCouponHbRecycleJob extends BaseJob {
	
	private static final Logger logger = Logger.getLogger(ReturnCouponHbRecycleJob.class);
	...
	public boolean execute(JobParam param) {
		RetArg retArg = retTimer.recycleCoupon();
