...
/**
 * 定时处理CancelOmsOrderTask记录
 * 
 * @author dingmingliang
 * 
 */
@Service
@JobPath("/order/timer/dealCancelOmsOrderTask")
public class DealCancelOmsOrderTaskJob extends BaseJob {
	...
	public boolean execute(JobParam param) {
		orderTimerFacade.dealCancelOmsOrderTask();
		return true;
	}
