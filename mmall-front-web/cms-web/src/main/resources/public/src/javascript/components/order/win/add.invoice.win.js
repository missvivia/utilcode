...
define(
		...
		function(u, v, e, t, Window, _t, p, o, f, r) {
			var pro;
			 ...
			 *
			 */
			p._$$InvoiceWin = NEJ.C();
			pro = p._$$InvoiceWin._$extend(Window);
			/**
			 * 控件重置
			 * @protected
			 * @method {__reset}
			...
			pro.__initNodeTemplate = function() {
				this.__seed_html = 'ntp-invoice-win';
			};
			/**
			 * 销毁控件
			 */
			...
			pro.__initNode = function() {
				...
				if(!!e._$get('invoiceTitle')){
					list[0].value = e._$get('invoiceTitle').innerText;
				}
