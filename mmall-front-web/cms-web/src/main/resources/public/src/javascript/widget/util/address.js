...
[ 'base/klass', 
  ...
  'base/element', 
  'util/event',
  '{pro}widget/layer/address.card/address.street.js?v=1.0.0.0'],
function(k, ut, v, e, t, AddressCard,p, o, f, r) {
	...
	pro.__onAddressClick = function(event){
		v._$stop(event);
		AddressCard._$allocate({parent:this.__addressIpt.parentNode,
			data:this.__data,onchange:this.__onChange._$bind(this),url : this.__url})
