...
NEJ.define([
    ...
    '{lib}/util/calendar/calendar.js?v=1.0.0.0',
    'util/template/tpl',
    'util/template/jst',
    'text!./datepick.css',
    'text!./datepick.html?v=1.0.0.0'
    ...
    _pro.__initNode = function(){
        ...
        var btn = _e._$getChildren(_list[2]);
        ...
        this.__copt.today = btn[0];
        this.__copt.clear = btn[1];
    };
    /**
     * 动态构建控件节点模板
     *
    ...
    _pro.__initNodeTemplate = function(){
        _seed_html = _t1._$addNodeTemplate(
            '<div class="'+_seed_css+' zcard">'+
               ...
               _t1._$getTextTemplate(_seed_btn)+
            '</div>'
        );
        this.__seed_html = _seed_html;
    };
