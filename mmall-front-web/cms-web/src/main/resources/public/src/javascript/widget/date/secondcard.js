...
NEJ.define(['{lib}ui/layer/card.wrapper.js',
  ...
  var _seed_css,_seed_html,_seed_date;
	  _p._$$SecondCard = NEJ.C();
    _pro = _p._$$SecondCard._$extend(_ui._$$CardWrapper);
    _sup = _p._$$SecondCard._$supro;
    ...
    _pro.__reset = function(_options){
      ...
      this.__doInitDomEvent([
            [this.__zday,'click',this.__onChangeSecond._$bind(this)]
        ]);
    };

    _pro.__onChangeSecond = function(_event){
      var _target = _v._$getElement(_event);
      if(_target.nodeName!='A') return;
      var _value = _target.innerText;
      this._$dispatchEvent('onsecondchange',_value);
      this._$hide();
    };
    ...
    _seed_date = _e._$addHtmlTemplate('\
        <table class="zday">\
          <tr>{list [0,10,20,30,40,50] as y}<td><a href="#" class="js-ztag">${y}</a></td>{/list}</tr>\
        </table>\
    ');
});