...
NEJ.define(['{lib}ui/layer/card.wrapper.js',
  ...
  var _seed_css,_seed_html,_seed_date;
	  _p._$$MinuteCard = NEJ.C();
    _pro = _p._$$MinuteCard._$extend(_ui._$$CardWrapper);
    _sup = _p._$$MinuteCard._$supro;
    ...
    _pro.__reset = function(_options){
      ...
      this.__doInitDomEvent([
            [this.__zday,'click',this.__onChangeMinute._$bind(this)]
        ]);
    };

    _pro.__onChangeMinute = function(_event){
      var _target = _v._$getElement(_event);
      if(_target.nodeName!='A') return;
      var _value = _target.innerText;
      this._$dispatchEvent('onminutechange',_value);
      this._$hide();
    };
    ...
    _seed_date = _e._$addHtmlTemplate('\
        <table class="zday">\
          {list 0..1 as x}\
          <tr>{list 0..5 as y}<td><a href="#" class="js-ztag">${x*30+y*5}</a></td>{/list}</tr>\
          {/list}\
        </table>\
    ');
});