...
<@wrap>
<@crumbs parent={"txt":"站点管理","url":'/site/site'} sub={"txt":"站点新建"}/>
<!-- card -->
  ...
  <div class="row">
    <div class="col-sm-8 col-sm-offset-2">
      <div class="m-card-btn m-card">
        <div class="cbtn_left"><a href="#" class="btn  btn-primary j-submit" name="create">确定</a></div>
        <div class="cbtn_right"><a href="javascript:history.go(-1);" class="btn  btn-default">返回</a></div>
      </div>
    </div>
  </div>
</@wrap>
