...
<style>
  ...
  #errorBox{display:none;z-index:97;}
  .input-group-lg > .input-group-addon{[;height: 23px;] }
</style>
</head>
<body>
            ...
            <div class="form-group">
              <div class="col-sm-10 col-sm-offset-1">
                <div class="input-group input-group-lg user-input-group">
                  ...
                  <input type="test" class="form-control ft16 ipt user" placeholder="请输入帐号" id="username" name="username" data-holder="js-placeholder" data-required="true" data-message="帐号不能为空">
                </div>
<!--
            ...
            <div class="form-group">
              <div class="col-sm-10 col-sm-offset-1">
                <div class="input-group input-group-lg pwd-input-group">
                  ...
                  <input type="password" class="form-control ft16 ipt psd" placeholder="请输入密码" id="password" name="password" data-holder="js-placeholder" data-required="true" data-message="密码不能为空">
                </div>
              </div>
            </div>
            <div class="form-group">
				<div class="col-sm-10 col-sm-offset-1">
					<div class="checkbox left">
					    <label>
					      <input type="checkbox" id='remember'>记住帐号
					    </label>
					</div>
<#--					
					<div class="right">
						<span title="请拨打电话0571-87651759">如忘记密码请<a href="#">联系管理员</a></span>
...
<div class="container">
  <div class="m-copyright">
    <div><a href="#" target="_blank" rel="nofollow" class="">About XYL</a> - <a href="#" target="_blank" rel="nofollow" class="">公司简介</a> - <a href="#" target="_blank" rel="nofollow" class="">招聘信息</a> - <a href="#" target="_blank" rel="nofollow" class="">相关法律</a> - <span>增值电信业务经营许可证：浙B2-20090185</span>
    </div>
    <div>新云联公司版权所有&nbsp;&nbsp;&copy;&nbsp;&nbsp;1997-2015</div>
  </div>
</div>
-->
<!-- @script -->
