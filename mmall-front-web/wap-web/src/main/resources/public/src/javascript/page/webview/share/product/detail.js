...
define([
	'{pro}widget/webview/swiper/swiper.scrollbar.js', // 对应对象Swiper(滑动封装函数)
	'./detailPage.js', // 对应对象detailPage(详情页)
	...
	var productManager = {
		...
		_$init : function() {
			...
			app.IphoneOpenUrl = 'mmall://page=2?itemId=' + PRODUCTDETAIL.product.productId; // 唤醒iPhone客户端对应详情页
			app.AndroidOpenUrl = 'mmallandroid://m.023.baiwandian.cn?page=2&itemId=' + PRODUCTDETAIL.product.productId; // 唤醒Android客户端对应详情页
