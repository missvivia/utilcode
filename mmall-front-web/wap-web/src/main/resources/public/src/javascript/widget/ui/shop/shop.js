...
NEJ.define([
    ...
    _pro.__reset = function(_options){
     ...
     // init event
        this.__doInitDomEvent([[this.__closeMapButton,"mousedown",
           this.__onHideMap._$bind(this)
        ]]);
    };
     ...
     * @return {Void}
     */
    _pro.__onHideMap=function(){
    	_e._$addClassName(this.__mbox,"f-dn");
    };
    /**
     * 控件销毁
     * @return {Void}
    ...
    _pro.__initNode = function(){
        ...
        /*close button*/
        this.__closeMapButton=_e._$getByClassName(this.__body,"m-map-close")[0];
    };
    /**
     * 区域变化事件
     * @return {Void}
    ...
    _pro.__onShopUpdate = (function(){
        ...
        var _doMarker = function(_marker,_type,_index){
            ...
            _marker.setIcon(
                new AMap.Icon({
                    image:_c._$get('root')+'3g/images/marker_map.png',
        ...
        var _onMarkerClick = function(_id){
            ...
            /*显示地图*/
            _e._$delClassName(this.__mbox,"f-dn");
        };
