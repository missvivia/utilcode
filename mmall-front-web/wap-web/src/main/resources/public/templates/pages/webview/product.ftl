...
<html>
	<head>
		...
		<link type="text/css" href="/src/css/page/webview/app_product.css" rel="stylesheet" />
		...
		<div class="g-container">
			...
			<div class="g-part-img">
				...
				<#list data.product.prodShowPicList as pic>
                    <img src="${(pic)!""}?imageView&quality=100&thumbnail=640y640" />
				</#list>
				<#if data.product.customEditHTML?has_content>
					${data.product.customEditHTML?replace('src="(.*?)"', 'src="$1?imageView&thumbnail=640x0&quality=100"', 'rim')}
				</#if>
				</div>
			</div>
