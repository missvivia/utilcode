...
public class OauthLoginController {
	...
	private static final String MAIN_SITE_DOMAIN = "baiwandian.cn";
	...
	public ModelAndView login(@PathVariable String app, HttpServletRequest request, HttpServletResponse response) {
		String redirectURL = ServletRequestUtils.getStringParameter(request, "redirectURL", "http://023.baiwandian.cn");
		String url = "http://reg.163.com/outerLogin/oauth2/connect.do?target=" + app
				+ "&url2=http://023.baiwandian.cn/login&product=paopao"
				+ "&url=http://023.baiwandian.cn/ext/callback?redirectURL=" + redirectURL;
