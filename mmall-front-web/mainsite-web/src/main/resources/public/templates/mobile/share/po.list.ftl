		...
		<div class="g-shop">
			...
			<#if result.total != 0>
				...
				<li>
					<div class="m-module">
						<#--点击跳转-->
						<a target="_blank" href=${"http://023.baiwandian.cn/detail?id="+l.id}>
							<#--商品大图-->
							<p class="m-module-img">
								<img src="${(l.listShowPicList[0])!""}?imageView&quality=90&thumbnail=320x0" onerror="this.src='/mobile/images/default.jpg'"/>
								<#--商品剩余数量计算-->
									<#assign num = 0>
...
<script src="/mobile/javascript/page/share/list/list.js"></script>