...
<html>
    <head>
        ...
        <link type="text/css" href="/mobile/css/mobileLogisticsAll.css" rel="stylesheet"/>
        <title>物流追踪</title>
        <!--[if lt IE 8]>      <![endif]-->
    </head>
    <body>
			                            	...
			                            	<#elseif t.OrderTrace?size == 1>
	                                        	<li class="m-order-detail">
	                                                ...
	                                                <#if t.OrderTrace[0].operater?? &&  t.OrderTrace[0].operater!=''>
	                                                    <span>${t.OrderTrace[0].operateOrg}&emsp;${t.OrderTrace[0].operate!}&emsp;当前操作人员:${t.OrderTrace[0].operater}&emsp;<a
	                                                            href=${"tel:"+(t.OrderTrace[0].operaterPhone)!}>${(t.OrderTrace[0].operaterPhone)!}</a>&emsp;${t.OrderTrace[0].note}</span>
	                                                <#--信息：无当前操作人员信息-->
	                                                <#else>
	                                                    <span>${t.OrderTrace[0].operateOrg!}&emsp;${t.OrderTrace[0].operate!}&emsp;${t.OrderTrace[0].note!}</span>
	                                                </#if>
	                                                <#--时间-->
	                                        	...
	                                        	<#list t.OrderTrace as tc>
	                                                <li class="m-order-details">
	                                                    ...
	                                                    <#if tc.operater?? && tc.operater!='' >
	                                                        <span>${tc.operateOrg}&emsp;${tc.operate!}&emsp;当前操作人员:${tc.operater}&emsp;<a
	                                                                href=${"tel:"+(tc.operaterPhone)!}>${(tc.operaterPhone)!}</a>&emsp;${tc.note}</span>
	                                                    <#--信息：无当前操作人员信息-->
	                                                    <#else>
	                                                        <span>${tc.operateOrg!}&emsp;${tc.operate!}&emsp;${tc.note!}</span>
	                                                    </#if>
	                                                    <#--时间-->
        ...
        <script src="/mobile/javascript/page/logistics.js"></script>
    </body>
</html>