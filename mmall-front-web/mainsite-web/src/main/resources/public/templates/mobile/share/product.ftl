...
<html>
	<head>
		...
		<link type="text/css" href="/mobile/css/mobileSwiper.css" rel="stylesheet" />
		<link type="text/css" href="/mobile/css/mobileShareProduct.css" rel="stylesheet" />
		<title>${(product.productName)!}-新品购</title>
		<!--[if lt IE 8]>      <![endif]-->
	</head>
	<body>
		<noscript></noscript>
		...
		<div class="g-container">
			<div class="swiper-container m-scontainer">
						...
						<div class="swiper-slide showpage1-slide">
								...
								<div class="swiper-container imgshow-container">
									...
									<#if product.prodShowPicList?has_content>
										<#list product.prodShowPicList as pic>
                                            <div class="swiper-slide imgshow-slide">
                                                <a href=${"http://023.baiwandian.cn/detail?id="+product.productId} target="_blank">
                                                    <img src="${(pic)!""}?imageView&quality=90&thumbnail=640y640" onerror="this.src='/mobile/images/default.jpg'"/>
                                                </a>
                                            </div>
										</#list>
									<#else>
                                        <div class="swiper-slide imgshow-slide">
                                            <a href="http://023.baiwandian.cn" target="_blank">
                                                <img src="/mobile/images/default.jpg"/>
                                            </a>
                                        </div>
									</#if>
                                    </div>
									<#if resnum == 0>
										<span class="m-module-saleout">
											<img src="/mobile/images/saleout.png"/>
										</span>
									</#if>
								</div>
							...
							<div class="m-ware-tip">
								...
								<#if canAccess != 0>
									...
									<p class="m-ware-info">
										专柜价：<del class="m-price-old">￥${product.marketPrice!}</del><span class="m-info-sales">销量&nbsp;${salenum}笔</span>
									</p>
								<#else>
                                    <p class="m-ware-info">
                                        销量&nbsp;${salenum}笔
				...
				<div class="m-showpage sp2">
					...
					<#--回顶按钮-->
					<div class="backTop">
						<img src="/mobile/images/backTop.png" width="36" />
					</div>
					<#--自定义滚动条-->
		...
		<script src="/mobile/javascript/page/share/product/detail.js"></script>
	</body>
</html>