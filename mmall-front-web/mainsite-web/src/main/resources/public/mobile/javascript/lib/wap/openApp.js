...
define([
    ...
    var openApp = {
        // Iphone 唤醒码
        IphoneOpenUrl: 'mmalliphone://',

        // Iphone itunes 唤醒
        IphoneGetUrl: 'http://itunes.apple.com/cn/app/wen-yi-sheng/id425349261?mt=8',

        // Android 唤醒码
        AndroidOpenUrl: 'mmallandroid://',

        // Android APK 下载地址
        AndroidGetUrl: 'http://023.baiwandian.cn/res/apps/mmall_v1.0.0_normal.apk',

        // PC 或  Wphone 跳转地址
        jumpUrl: 'http://023.baiwandian.cn',
