...
define([
	'{pro}/page/share/list/listPage.js', // 对应对象detailPage(详情页)
	...
	var poManager = {
		...
		_$init : function() {
			...
			/*唤醒对应专场页的App*/
			app.IphoneOpenUrl = 'mmalliphone://page=1?itemId=' + listId; // 唤醒iPhone客户端对应PO页
			app.AndroidOpenUrl = 'mmallandroid://page=1?itemId=' + listId; // 唤醒Android客户端对应PO页
