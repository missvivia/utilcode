...
define([
	...
	_wap._$domReady(function() {
		...
		/*绑定一级菜单事件*/
		var 
			dropdown = _wap._$('.m-help-dropdown'), // 一级菜单node
			dropH = dropdown[0].offsetHeight; // 标记一级菜单高度
		
		    // 二级菜单展示绑定
			dropdown._$forEach(function(el) {
			var
				button = el.querySelector('.m-help-tip1'), // 点击展示二级菜单
				dropdownMenu = el.querySelector('.m-help-dropdownMenu'), // 二级菜单
