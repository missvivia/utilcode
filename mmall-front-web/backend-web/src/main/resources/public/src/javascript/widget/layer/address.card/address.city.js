...
define(['base/klass'
        ...
        ,'pro/extend/request'
        , 'util/template/jst'], 
        function(k,ut, _v, _e, t,i,e1,html,request,e2,p, o, f, r) {
	var pro, sup,
	...
	pro.__getProvince2 = function(){
		if(!_provinceListCache){
			//  /src/javascript/widget/layer/address.card/mock/province.json
			request('/brand/shop/province',{
				onload:this.__cbGetProvince._$bind(this),
				onerror:this.__cbGetProvince._$bind(this),
				type:'json'
			})
	...
	pro.__cbGetProvince = function(result){
		if(result.code==200){
			...
			var _arr=[];
			var _decade={key:"A-Z",value:result.shopProvinces};
			_arr.push(_decade);
			_provinceListCache=_arr;
		}
