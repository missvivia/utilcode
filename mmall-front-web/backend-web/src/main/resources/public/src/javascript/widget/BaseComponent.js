...
define([
  ...
  "{pro}widget/regular/directive/index.js",
  "{pro}widget/regular/filter.js",
  "{pro}widget/regular/module/form.js",
  "{pro}extend/request.js"
], function(x, u, e, directive, filters, formModule,request){
   ...
   * @return {[type]} [description]
   */
  BaseComponent.boot = function(options){

    options = options || {}

    var PageHub = Hub.extend(options);
