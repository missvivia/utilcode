...
define([  '{lib}base/klass.js'
         ...
         ,'{pro}widget/item/posku/posku.js'
         ,'{pro}widget/pager/pager.js'
         ,'{pro}widget/cache/posku.cache.list.js'], 
    function(k, t, t1, item, pg, cache, p, o, f, r) {
		var pro;
		p._$$POSKU = k._$klass();
		pro = p._$$POSKU._$extend(t._$$EventTarget);
		...
		pro.__reset = function(options) {
			...
			this.mdl = t1._$$ListModulePG._$allocate({
				...
				item: {
					klass: item._$$POSKUItem,  // data1不变
					prefix: 'g-item'
				...
				cache: {
					...
					klass: cache._$$CacheListPOSKU   // data3变化
				},
