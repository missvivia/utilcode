...
/**
 * 商家后台错误处理controller，用以处理带错误代码的重定向请求。 示例代码：
 ...
 */
@Controller
public class BackendErrorController extends BasicErrorController {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.springframework.boot.autoconfigure.web.BasicErrorController#errorHtml(javax.servlet.http.HttpServletRequest)
	 */
