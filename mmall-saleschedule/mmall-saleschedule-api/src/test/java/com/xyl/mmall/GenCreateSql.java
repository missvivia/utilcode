...
public class GenCreateSql {
	...
	String metaPackageName = "com.xyl.mmall.saleschedule.meta";
	
	String filePathOfSql = "c:/mmall-saleschedule-create.sql";
	...
	public void genCreateSql() {
		...
		for (String classPath : classPathList) {
			...
			try {
				...
				String dropSql = "DROP TABLE IF EXISTS " + annonOfClass.tableName() + ";";
