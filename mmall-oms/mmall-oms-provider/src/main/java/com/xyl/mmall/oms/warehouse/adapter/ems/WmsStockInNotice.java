...
public class WmsStockInNotice {
	 ...
	 * 发货方信息
	 */
	@MapField(WMSShipOrderDTO.field_senderCode)
	private String sender_code = "";

	@MapField(WMSShipOrderDTO.field_senderName)
	private String sender_name = "";

	@MapField(WMSShipOrderDTO.field_senderAddress)
	private String sender_contact = "";

	@MapField(WMSShipOrderDTO.field_senderPhone)
	private String sender_phone = "";

	/**
	 * 物流信息
	 */
	@MapField(WMSShipOrderDTO.field_logisticCode)
	private String logisticProviderId = "";

	@MapField(WMSShipOrderDTO.field_logisticCompany)
	private String logisticProviderName = "";

	@MapField(WMSShipOrderDTO.field_logisticNo)
	private String tms_order_code = "";

	@MapField(value = WMSShipOrderDTO.field_sendTime, isDate=true)
	private String send_time = "";

	@MapField(value = WMSShipOrderDTO.field_expectedTime, isDate=true)
	...
	@MapField(WMSShipOrderDTO.field_skuCount)
	private long sku_count;

	/**
	 * 其他信息
	 */
	@MapField(WMSShipOrderDTO.field_note)
	private String remark = "";

	@XmlElementWrapper(name = "details")
	@XmlElement(name = "detail")
	@MapField(WMSShipOrderDTO.field_skuDetails)
	...
	public String getLogisticProviderName() {
		return this.logisticProviderName;
	}
