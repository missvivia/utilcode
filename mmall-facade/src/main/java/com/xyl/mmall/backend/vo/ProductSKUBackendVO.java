...
/**
 * ProductSKUBackendVO.java created by yydx811 at 2015年5月15日 下午3:57:32
 * 商品vo
 *
 * @author yydx811
 */
public class ProductSKUBackendVO extends BaseVersionVO {
	...
	/** 商品属性. */
	private List<ProdParamBackendVO> paramList;
	...
	/** 商品限购配置. */
	private ProductSKULimitConfigVO skuLimitConfigVO;
	
	public ProductSKUBackendVO() {
	}

	public ProductSKUBackendVO(ProductSKUDTO obj) {
		...
		this.batchCash = obj.getBatchCash();
		this.supplierId = obj.getBusinessId();
		this.productSaleNum = obj.getSaleNum();
		this.isSKULimited = obj.getIsLimited();
		this.updateTimeStr = DateUtil.dateToString(obj.getUpdateTime(), DateUtil.LONG_PATTERN);
		this.productUrl = UrlBaseUtil.buildProductUrl(obj.getId());
		this.storeUrl = UrlBaseUtil.buildStoreUrl(obj.getBusinessId());
	...
	public ProductSKUDTO convertToDTO() {
		...
		skuDTO.setName(productName);
		skuDTO.setCategoryNormalId(categoryNormalId);
		skuDTO.setBrandId(brandId);
		skuDTO.setIsLimited(isSKULimited);
		if (prodDetail != null) {
	...
	public List<ProdParamBackendVO> getParamList() {
		return paramList;
	}

	public void setParamList(List<ProdParamBackendVO> paramList) {
	...
	public int getIsSKULimited() {
		return isSKULimited;
	}

	public void setIsSKULimited(int isSKULimited) {
		this.isSKULimited = isSKULimited;
	}

	public ProductSKULimitConfigVO getSkuLimitConfigVO() {
		return skuLimitConfigVO;
	}

	public void setSkuLimitConfigVO(ProductSKULimitConfigVO skuLimitConfigVO) {
		this.skuLimitConfigVO = skuLimitConfigVO;
	}
}
