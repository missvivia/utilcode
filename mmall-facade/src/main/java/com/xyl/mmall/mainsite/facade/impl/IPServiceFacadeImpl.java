 ...
 * 
 */
@Facade("ipServiceFacade")
public class IPServiceFacadeImpl implements IPServiceFacade {

	private static final Logger LOGGER = LoggerFactory.getLogger(IPServiceFacadeImpl.class);
