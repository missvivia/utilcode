 ...
 * @since 1.0
 */
public class CartSkuItemVO implements Comparable<CartSkuItemVO>, Serializable, HasShowIndex2<Long> {
	 ...
	 * 商品限购
	 */
	private MainsiteSKULimitConfigVO limitConfigVO;
	...
	public MainsiteSKULimitConfigVO getLimitConfigVO() {
		return limitConfigVO;
	}

	public void setLimitConfigVO(MainsiteSKULimitConfigVO limitConfigVO) {
		this.limitConfigVO = limitConfigVO;
	}
	...
	@Override
	public int compareTo(CartSkuItemVO another) {
		if (this == another)
			return 0;
		if (this.getCreateTime() < another.getCreateTime()) {
			return 1;
		} else if (this.getCreateTime() > another.getCreateTime()) {
			return -1;
		}
		return 0;
	}
