...
import com.xyl.mmall.mainsite.vo.order.OrderActionVO;
...
import com.xyl.mmall.mainsite.vo.order.OrderNoActionVO;
 ...
 * 
 */
public class MainsiteVOConvertUtil {
...
//	}
	...
	private static OrderSkuVO convertToOrderSkuVO(OrderSkuDTO orderSkuDTO, Boolean isSnapShot) {
		...
		vo.setSkuSPDTO(convertToSkuSPVO(orderSkuDTO.getSkuSPDTO(), isSnapShot, orderSkuDTO));
