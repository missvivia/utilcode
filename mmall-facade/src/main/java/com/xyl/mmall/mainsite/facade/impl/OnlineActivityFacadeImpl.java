...
import com.xyl.mmall.mainsite.vo.LotteryGiftVO;
 ...
 */
@Facade
public class OnlineActivityFacadeImpl implements OnlineActivityFacade {
...
//		}
	...
	private int lottery() {
		...
		int ret = LotteryUtil.getInstance().doLottery(orderCntList);
		if (ret == -1) {
			return ret;
		}
