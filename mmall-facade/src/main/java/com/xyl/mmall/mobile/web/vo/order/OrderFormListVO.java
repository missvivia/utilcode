...
public class OrderFormListVO {
	...
	public OrderFormListVO(OrderFormDTO orderFormDTO) {
		...
		this.orderSkuList = MobileVOConvertUtil.convertToOrderSkuVOList(orderFormDTO.getOrderSkuDTOListOfOrdGift(), true);
	...
	public void setPayCloseCDAndOrderForm(long orderTime){
		...
		if (orderTime + ConstValueOfOrder.MAX_PAY_TIME > currTime&& this.getOrderFormState() == OrderFormState.WAITING_PAY) {
