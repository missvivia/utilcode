...
import com.xyl.mmall.mobile.web.facade.MobileRedPacketDetailFacade;
 ...
 * @since      1.0
 */
@Facade("mobileRedPacketDetailFacade")
public class MobileRedPacketDetailFacadeImpl implements MobileRedPacketDetailFacade {
