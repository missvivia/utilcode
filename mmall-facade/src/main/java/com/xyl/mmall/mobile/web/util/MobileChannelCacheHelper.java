...
import com.xyl.mmall.mobile.web.facade.MobileMainBrandFacade;
import com.xyl.mmall.mobile.web.vo.ChannelDataVo;


@Component
public class MobileChannelCacheHelper {
	...
	@Autowired
	private MobileIPServiceFacade iPServiceFacade;

	@Autowired
	private MobileMainBrandFacade mainBrandFacade;
	...
	private static final Logger logger = LoggerFactory.getLogger(MobileChannelCacheHelper.class);
