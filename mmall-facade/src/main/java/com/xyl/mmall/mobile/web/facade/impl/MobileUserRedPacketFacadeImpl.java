...
import com.xyl.mmall.mobile.web.facade.MobileUserRedPacketFacade;
 ...
 * @since      1.0
 */
@Facade("mobileUserRedPacketFacade")
public class MobileUserRedPacketFacadeImpl implements MobileUserRedPacketFacade {
