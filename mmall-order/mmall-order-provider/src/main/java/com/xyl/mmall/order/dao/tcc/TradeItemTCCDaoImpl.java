 ...
 */
@Repository
public class TradeItemTCCDaoImpl extends PolicyObjectDaoSqlBaseOfAutowired<TradeItemTCC> implements TradeItemTCCDao {
	 ...
	 */
	public List<TradeItemTCC> getListByTranId(long tranId) {
