 ...
 */
@Repository
public class OrderFormTCCDaoImpl extends PolicyObjectDaoSqlBaseOfAutowired<OrderFormTCC> implements OrderFormTCCDao {
	 ...
	 */
	public List<OrderFormTCC> getListByTranId(long tranId) {
