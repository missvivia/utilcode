 ...
 * 
 */
@AnnonOfClass(desc = "到付申请审核日志-TCC", tableName = "Mmall_Order_CODAuditLogTCC")
public class CODAuditLogTCC extends CODAuditLog implements Serializable, TCCMetaInterface {
