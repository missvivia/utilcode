 ...
 * 
 */
@AnnonOfClass(desc = "订单快递地址信息-TCC", tableName = "Mmall_Order_OrderExpInfoTCC")
public class OrderExpInfoTCC extends OrderExpInfo implements Serializable, TCCMetaInterface {
