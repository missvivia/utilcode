 ...
 */
@Repository
public class UpdateOrderStateTCCDaoImpl extends PolicyObjectDaoSqlBaseOfAutowired<UpdateOrderStateTCC> implements
		UpdateOrderStateTCCDao {
	 ...
	 */
	public List<UpdateOrderStateTCC> getListByTranId(long tranId) {
