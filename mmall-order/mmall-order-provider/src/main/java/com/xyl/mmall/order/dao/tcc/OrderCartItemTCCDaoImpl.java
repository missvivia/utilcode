 ...
 */
@Repository
public class OrderCartItemTCCDaoImpl extends PolicyObjectDaoSqlBaseOfAutowired<OrderCartItemTCC> implements
		OrderCartItemTCCDao {
	 ...
	 */
	public List<OrderCartItemTCC> getListByTranId(long tranId) {
