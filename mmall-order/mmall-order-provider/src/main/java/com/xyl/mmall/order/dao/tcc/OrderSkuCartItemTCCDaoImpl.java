 ...
 */
@Repository
public class OrderSkuCartItemTCCDaoImpl extends PolicyObjectDaoSqlBaseOfAutowired<OrderSkuCartItemTCC> implements OrderSkuCartItemTCCDao {
	 ...
	 */
	public List<OrderSkuCartItemTCC> getListByTranId(long tranId) {
