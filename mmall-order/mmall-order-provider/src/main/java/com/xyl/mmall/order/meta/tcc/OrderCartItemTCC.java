 ...
 * 
 */
@AnnonOfClass(desc = "订单明细-TCC", tableName = "Mmall_Order_OrderCartItemTCC")
public class OrderCartItemTCC extends OrderCartItem implements Serializable, TCCMetaInterface {
