 ...
 * 
 */
@AnnonOfClass(desc = "发票信息-订单维度-TCC", tableName = "Mmall_Order_InvoiceInOrdTCC")
public class InvoiceInOrdTCC extends InvoiceInOrd implements Serializable, TCCMetaInterface {
