 ...
 * 
 */
public class GenCreateSqlOfLinux {

	String metaPackageName = "com.xyl.mmall.cms.meta";
	
	String filePathOfSql = "script/mmall-cms-create.sql";
	...
	public List<String> genClassPathList() {
		...
		String foldPath = "./target/classes/" + metaPackageName.replaceAll("\\.", "/");
	...
	public static void main(String[] argv) {
		GenCreateSqlOfLinux obj = new GenCreateSqlOfLinux();
		obj.genCreateSql();
	}
}
